...
public class TextureManager {
	...
	private static void createTexture(String name, int filter){
		...
		glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, i.getWidth(), i.getHeight(), 0, GL_RGBA, GL_UNSIGNED_BYTE, BufferUtil.asDirectByteBuffer(getImageData(i)));
	...
	public static void clean(String texture){
		GL11.glDeleteTextures(textures.get(texture));
	}
