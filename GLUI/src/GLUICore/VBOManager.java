...
public class VBOManager {
	 ...
	 */
	public static void createStaticVBO(String filename, int type, InterleavedVBO interleaving) {
		int vboID = glGenBuffers();
		int indID = glGenBuffers();

		float[] vert = ResourceManager.getVertexData(filename);

		VBO v = new VBO(vboID, indID, vert.length, type, interleaving);

		v.bufferData(vert, GL_STATIC_DRAW);
